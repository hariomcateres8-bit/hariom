...
<img
        ...
        <div className="relative max-w-5xl mx-auto px-4 text-center text-primary-foreground">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-primary-foreground/10 backdrop-blur-md border border-primary-foreground/20 rounded-full px-4 py-1.5 text-xs tracking-widest uppercase mb-4">
              <Sparkles className="w-3.5 h-3.5 text-gold" /> Get In Touch
            </div>
            <h1 className="text-5xl md:text-7xl font-display font-bold">
              Let's craft your <span className="text-gradient-white">royal feast</span>.
            </h1>
            <p className="mt-6 text-lg md:text-xl text-primary-foreground/85 max-w-2xl mx-auto font-light">
...
<div className="bg-card rounded-3xl overflow-hidden shadow-card border border-border/50">
  ...
  <div className="w-full h-[350px]">
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3643.8877029083555!2d72.52250627527975!3d23.00247687918782!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e852e5aace4e9%3A0xbb2c897bf0fb404a!2sHariOm%20Caterers!5e1!3m2!1sen!2sin!4v1786365496941!5m2!1sen!2sin"
      width="100%"
      height="100%"
      style={{ border: 0 }}
      allowFullScreen
      ...
      title="HariOm Caterers Google Maps Location"
    />
  </div>
</div>
        </motion.div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className={`px-3.5 py-1.5 rounded-full text-xs font-semibold transition-all cursor-pointer ${
              isCustomEvent
                ? "bg-gradient-gold text-gold-foreground shadow-sm scale-105 ring-2 ring-gold"
        ...
        {isCustomEvent && (
          ...
          >
            <input
              ...
              className="w-full border-2 border-gold/60 bg-amber-50/50 dark:bg-amber-950/20 px-4 py-2.5 rounded-xl outline-none focus:ring-2 focus:ring-primary text-sm font-medium"
              autoFocus
            />
          </motion.div>
        )}
