      ...
      <section className="relative py-20 overflow-hidden bg-slate-950">
        <div className="absolute inset-0">
          <img
            ...
            alt="Package Planner Hero Background"
            className="w-full h-full object-cover opacity-35"
          />
          <div className="absolute inset-0 bg-gradient-hero" />
        </div>
        <div className="relative max-w-6xl mx-auto px-4 text-primary-foreground text-center">
          <div className="inline-flex items-center gap-2 text-xs tracking-widest uppercase text-gold">
            <span className="h-px w-8 bg-gold" /> Package Planner{" "}
            <span className="h-px w-8 bg-gold" />
          </div>
          <h1 className="mt-4 text-4xl md:text-5xl">Plan your Package Functions</h1>
