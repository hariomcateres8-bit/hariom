...
import logo from "@/assets/hariom-logo.png.asset.json";
import {
  PdfExporterSection,
  type MealPlan,
...
<img
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-primary-foreground">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 text-xs tracking-widest uppercase text-gold font-semibold">
              <span className="h-px w-8 bg-gold" /> Hariom Caterers Custom Menu Planner{" "}
              <span className="h-px w-8 bg-gold" />
            </div>
            <h1 className="mt-3 text-3xl md:text-5xl font-display font-bold">
              Design Your Custom Event Menu
            </h1>
            <p className="mt-3 text-primary-foreground/85 max-w-2xl mx-auto text-sm md:text-base">
              Add multiple meal sessions, select pure vegetarian delicacies, and generate a 4-page
            ...
            <div className="flex flex-col items-center flex-1">
              <div
                className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm transition ${
                    ...
                    : active
                      ? "bg-primary text-primary-foreground ring-4 ring-gold/40"
            ...
            {idx < steps.length - 1 && (
              <div
                className={`h-0.5 flex-1 transition ${
                  step > s.num ? "bg-gold" : "bg-primary-foreground/20"
                }`}
              />
            )}
          </div>
...
function MealsStep({
  ...
  <label
    htmlFor="searchDish"
    className="text-xs font-semibold uppercase text-muted-foreground whitespace-nowrap"
  >
    Quick Dish Filter
  </label>
