    ...
    <section className="py-24 bg-gradient-to-b from-primary/5 via-background to-primary/5 relative overflow-hidden border-y border-border">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <div className="inline-flex items-center gap-2 bg-amber-500/15 border border-amber-500/30 text-amber-900 dark:text-amber-200 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-wider">
        ...
        >
          <div className="relative bg-card rounded-3xl p-8 sm:p-12 border border-border shadow-2xl overflow-hidden transition-all duration-500">
            ...
            <Quote className="absolute -top-4 -right-4 w-44 h-44 text-amber-500/10 pointer-events-none" />
