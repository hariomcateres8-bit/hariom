...
export function TypewriterText({
  ...
  return (
    <span className={`inline-inline-block font-display font-extrabold ${className}`}>
      <span className="text-gradient-gold">{currentText}</span>
      <span className="inline-block w-[3px] h-[0.85em] bg-amber-400 ml-1 align-middle animate-pulse rounded-full shadow-[0_0_8px_#f59e0b]" />
    </span>
  );
}
